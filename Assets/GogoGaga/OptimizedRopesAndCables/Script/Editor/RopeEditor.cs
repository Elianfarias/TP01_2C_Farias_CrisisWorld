...
namespace GogoGaga.OptimizedRopesAndCables
{
    ...
    public class RopeEditor : Editor
    {
        ...
        {
            if (component.StartPoint != null && component.EndPoint != null)
            {
                if (GUILayout.Button("Create Points"))
                {
                    ...
                    component.SetStartPoint(newStartPoint.position,true);
                    ...
                    component.SetEndPoint(newEndPoint.position,true);
                    
                    if (component.MidPoint != null)
                    {
                        ...
                        component.SetMidPoint(newMidPoint.position, true);
                    }
